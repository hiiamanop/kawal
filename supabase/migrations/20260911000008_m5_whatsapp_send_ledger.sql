CREATE TABLE whatsapp_send_ledger (
...
CREATE INDEX ix_whatsapp_send_ledger_case ON whatsapp_send_ledger (case_id);
CREATE INDEX ix_whatsapp_send_ledger_status ON whatsapp_send_ledger (status) WHERE status IN ('PENDING', 'DELIVERY_UNKNOWN');
